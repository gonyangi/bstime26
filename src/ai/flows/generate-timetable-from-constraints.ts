...
/**
 * @fileOverview An AI agent for generating timetables based on constraints.
 * This file exports:
 *
...
const TimetableInputSchema = z.object({
  ...
  unavailableSlots: z
    .array(z.string())
    .describe(
      'An array of unavailable time slots, formatted as "room-day-period" e.g., "science-mon-1".'
    ),
});
...
const prompt = ai.definePrompt({
  name: 'generateTimetableFromConstraintsPrompt',
...
const generateTimetableFlow = ai.defineFlow(
  {
    name: 'generateTimetableFromConstraintsFlow',
